    ...
    def resetDefaults(self):
        ...
        if (a):
            ...
            if ('darwin' or 'linux') not in sys.platform:  
                ...
                if (os.path.exists('/Library/Application Support/Measurement Model')):
                    with open("/Library/Application Support/Measurement Modelsettings.ini", 'w+') as configfile:
                        config.write(configfile)
                        configfile.close()
                else:
                    os.makedirs('/Library/Application Support/Measurement Model')
                    with open("/Library/Application Support/Measurement Model/settings.ini", 'w') as configfile:
                        config.write(configfile)
                        configfile.close()
            self.applySettings()
    ...
    def saveSettings(self, e=None):
        ...
        try:
            ...
            if ('darwin' or 'linux') not in sys.platform:
                ...
                settingsDirectoryPath = "/Library/Application Support/Measurement Model"
